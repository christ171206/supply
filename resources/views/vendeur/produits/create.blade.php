    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Créez un nouveau produit dans votre catalogue</p>
            </div>
        ...
        <!-- Formulaire -->
        <form action="{{ route('vendeur.produits.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
